...
class MainMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        mathbtn = tk.Button(self, text = "Maths", command= lambda *args: [subject_select(1), print(subject), controller.show_frame("QuizPage")])
        mathbtn.pack()
...
class QuizPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.questionLabel = tk.Label(self, text=question[self.q_no], width=60, height=2,
