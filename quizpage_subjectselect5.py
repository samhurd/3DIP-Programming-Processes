...
class MainMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        mathbtn = tk.Button(self, text = "Maths", command= lambda: [subject_select(1), controller.up_frame("QuizPage")])
        mathbtn.pack()

        phybtn = tk.Button(self, text = "Physics", command= lambda: [subject_select(2), controller.up_frame("QuizPage")])
        phybtn.pack()

        engbtn = tk.Button(self, text = "English", command= lambda: [subject_select(3), controller.up_frame("QuizPage")])
        engbtn.pack()

        sosbtn = tk.Button(self, text = "Social Studies", command= lambda: [subject_select(4), controller.up_frame("QuizPage")])
        sosbtn.pack()        
...
class QuizPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.questionLabel = tk.Label(self, text=question[self.q_no], width=50, height=2,
    ...
    def start_quiz(self):
        ...
        self.questionLabel.pack(anchor=W)
