...
class MainMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        mathbtn = tk.Button(self, text = "Maths", command= lambda *args : [controller.up_frame("QuizPage"), subject=1])
        mathbtn.pack()

        engbtn = tk.Button(self, text = "English", command= lambda: [controller.up_frame("QuizPage"), subject=2])
        engbtn.pack()
