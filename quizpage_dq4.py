...
class QuizPage(tk.Frame):
    ...
    def buttons(self):
        ...
        self.next_button.place(x=5, y=80)
...
class LoginPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button = tk.Button(self, text = "Enter quiz", command= lambda: controller.up_frame("MainMenu"))
        button.pack()
...
class WelcomeScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button = tk.Button(self, text = "Enter quiz", command= lambda: controller.up_frame("LoginPage"))
        button.pack()
