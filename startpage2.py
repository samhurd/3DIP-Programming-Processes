...
#controller of all the pages, setting up main functions, styles etc..
    ...
    def __init__(self, *args, **kwargs):
        ...
        for p in (MainMenu, QuizPage, WelcomeScreen, SplashScreen):
...
class MainMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        results_btn = tk.Button(self, text = "See your results")
        results_btn.pack()  
...
class QuizPage(tk.Frame):
    ...
    def reset_quiz(self):
        ...
        self.quiz_title()
        return_button = tk.Button(self, text="Return to main menu", 
            command=lambda *args: [MainFrame.show_frame("MainMenu")], 
            fg="black",font=("ariel",16," bold"))
...
class WelcomeScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.quiz_button = tk.Button(self, text = "Submit", command=self.check_num)
    ...
    def check_num(self):
        try:
            ...
            self.msg.config(text="Success")
            self.check_age()

        except ValueError:
            self.msg.config(text="Please enter a numerical value ")
    ...
    def check_age(self):
        if 11 <= int(self.yr_lvlEntry.get()) <= 13:
            ...
            self.msg.config(text="You are not the intended Year level for this quiz")
...
class SplashScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.after(300, lambda: controller.show_frame("WelcomeScreen"))  
