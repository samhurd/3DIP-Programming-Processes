...
class MainFrame(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for p in (MainMenu, QuizPage, WelcomeScreen):
...
class QuizPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        subjectlabel = tk.Label(self, font = controller.titlefont)
        subjectlabel.pack()
...
class WelcomeScreen(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text = "Welcome to the \n BDSC General Revision Quiz! \n", font = controller.titlefont)
        label.pack()
        
        self.after(1000, lambda: controller.up_frame("MainMenu")) 
